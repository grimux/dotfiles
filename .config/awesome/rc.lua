...
music = "sonata"
termmusic = terminal .. " -e ncmpcpp" 
termfile = terminal .. " -e ranger"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "dev", "www", "sys", "doc", "torr", "chat", "mus", "vid", "gfx" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "m",     function () awful.spawn(termmusic) end,
    ...
    awful.key({ modkey,        }, "F5",     function () awful.spawn("xow-toggle") end,
              { description = "xow-toggle", group = "launcher"}),
   ...
   awful.key({}, "Print", function () awful.spawn("screenshooter") end),
    ...
    -- dmenu
    awful.key({ modkey },            "space",     function () awful.spawn("dmenu_run -p run: ") end,
              {description = "dmenu", group = "launcher"}),
    awful.key({ modkey, "Shift" },            "space",     function () awful.spawn("sudo dmenu_run -p sudo: ") end,
              {description = "dmenu", group = "launcher"}),
    ...
    -- Menubar
    awful.key({ "Control", "Shift" }, "p", function() menubar.show() end,
...
awful.spawn.with_shell("wmname LG3D") -- java fix
